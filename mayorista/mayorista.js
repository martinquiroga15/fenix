const sheetID = '1Hgpjs4Y0ExyqfvTh75fKqvf1FgB1CeJkl16lJLLTDHg'
const apiKey = 'AIzaSyATDa0aaG2HCpoHXGcQ1sAWsIDM1tqGsSQ';
const sheetURL = `https://sheets.googleapis.com/v4/spreadsheets/${sheetID}/values/hoja2?key=${apiKey}`;
...
document.getElementById('send-order').addEventListener('click', () => {
    ...
    const whatsappURL = `https://wa.me/3416776738?text=${encodeURIComponent(message)}`;
